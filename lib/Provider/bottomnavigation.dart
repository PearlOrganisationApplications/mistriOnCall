...
class HomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      Container(
        ...
        child: const Row(
          ...
          children: [
            Text(
              'Handyman',
              style: TextStyle(color: Colors.black,fontSize: 20.0,fontWeight: FontWeight.bold), // Set text color
            ),
            Text(
              'View All',
              style: TextStyle(color: Colors.blue,fontSize: 14.0), // Set text color
            ),
          ],
        ),
      ),
      ...
      Container(
        color: AppColor.lightblue, // Set your desired background color
        padding: EdgeInsets.only(top:10.0,bottom: 16.0), // Adjust padding as needed
      ...
      Row(
        ...
        children: [
          ...
          Container(
            ...
            Container(
              color: AppColor.lightblue, // Set your desired background color
              padding: EdgeInsets.only(top:10.0,bottom: 46.0), // Adjust padding as needed
                        ...
                        children: [
                          Container(
                                ...
                                Column(
                                  children: [
                                    Stack(
                                      children:[
                                        Image.asset(
                                          'assets/images/image_services.png', // Replace with your image URL
                                         width: 157.0,
                                          height: 100.0,
                                          fit:BoxFit.fill
                                          // Set the desired height
                                        ...
                                        Container(
                                          margin: EdgeInsets.only(top: 88.0,left:100.0), // Set the desired margin top
                                          child: Image.asset(
                            ...
                            child: Image.asset(
                              ...
                              width: 34.0,
                              height: 14.0,
                              fit:BoxFit.fill// Replace with your image URL
                              // Set the desired height
                              // Set the BoxFit property as needed
                            ),
             ...
             child:const Text(
               ...
               style: TextStyle(color: Colors.black,fontSize: 10.0),
                                    ...
                                    const Padding(
                                      ...
                                      child: Text(
                                        'Painting For ',textAlign: TextAlign.left,
                                    ...
                                    const Padding(
                                      ...
                                      child: Text(
                                        'Beautiful Homes... ',textAlign: TextAlign.left,
                                        style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold,fontSize: 18.0),
                                      ),
                                    ),
                                    Padding(
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            Image.asset(
                                                'assets/images/image_pr.png', // Replace with your image URL
                                                width: 30.0,
                                                height: 30.0,
                                                fit:BoxFit.fill
                                              // Set the desired height
